...
namespace AusDdrApi.Migrations
{
    ...
    [Migration("20210227233244_AddBadgesWithDancerAssociation")]
    partial class AddBadgesWithDancerAssociation
    {
            ...
            modelBuilder.Entity("AusDdrApi.Entities.Score", b =>
                {
                    ...
                    b.Property<DateTime>("SubmissionTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 2, 27, 23, 32, 43, 679, DateTimeKind.Utc).AddTicks(5510));
